...
{
	struct dentry *dir = debugfs_create_dir("usb_sifslv_u2phy", regs_dir);
	PRINT_IF_ERROR(dir);

	PRINT_IF_ERROR(REGISTER_FILE(dir, USB_SIFSLV_U2PHY_BASE, USB_U2PHYACR4));
	PRINT_IF_ERROR(REGISTER_FILE(dir, USB_SIFSLV_U2PHY_BASE, USB_USBPHYACR6));
	PRINT_IF_ERROR(REGISTER_FILE(dir, USB_SIFSLV_U2PHY_BASE, USB_U2PHYDTM0));
	PRINT_IF_ERROR(REGISTER_FILE(dir, USB_SIFSLV_U2PHY_BASE, USB_U2PHYDTM1));

	PRINT_IF_ERROR(REGISTER_FILE(dir, SSUSB_SIFSLV_U2PHY_BASE, U3D_U2PHYACR4));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SSUSB_SIFSLV_U2PHY_BASE, U3D_USBPHYACR6));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SSUSB_SIFSLV_U2PHY_BASE, U3D_U2PHYDTM0));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SSUSB_SIFSLV_U2PHY_BASE, U3D_U2PHYDTM1));

	PRINT_IF_ERROR(REGISTER_FILE(dir, SSUSB_SIF2SLV_U2PHY_BASE, U3D_2_U2PHYACR4));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SSUSB_SIF2SLV_U2PHY_BASE, U3D_2_USBPHYACR6));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SSUSB_SIF2SLV_U2PHY_BASE, U3D_2_U2PHYDTM0));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SSUSB_SIF2SLV_U2PHY_BASE, U3D_2_U2PHYDTM1));
}
