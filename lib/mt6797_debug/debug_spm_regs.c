...
{
	struct dentry *dir = debugfs_create_dir("spm", regs_dir);
	PRINT_IF_ERROR(dir);
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, PWR_STATUS));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, MFG_ASYNC_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, MFG_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, MFG_CORE0_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, MFG_CORE1_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, MFG_CORE2_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, MFG_CORE3_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, VDE_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, VEN_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, ISP_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, DIS_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, AUDIO_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, IFR_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, DPY_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, DPY_CH1_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, MD1_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, MD2_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, C2K_PWR_CON));
	PRINT_IF_ERROR(REGISTER_FILE(dir, SPM_BASE, MFG_SRAM_CON));
}
