...
{
	struct dentry *dir = debugfs_create_dir("io_cfg_l", regs_dir);
	PRINT_IF_ERROR(dir);

	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, IES_CFG0));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, IES_CFG1));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, SR_CFG0));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, SR_CFG1));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, SMT_CFG0));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, SMT_CFG1));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, TDSEL_CFG0));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, TDSEL_CFG1));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, TDSEL_CFG2));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, RDSEL_CFG0));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, RDSEL_CFG1));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, PU_CFG0));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, PU_CFG1));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, PD_CFG0));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, PD_CFG1));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, DRV_CFG0));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, DRV_CFG1));
	PRINT_IF_ERROR(REGISTER_FILE(dir, IO_CFG_L_BASE, R0_CFG0));
}
